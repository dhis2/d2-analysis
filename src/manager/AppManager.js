...
AppManager = function() {
    ...
    t.defaultAnalysisFields = [
        ...
        'columns[dimension,filter,items[dimensionItem|rename(id),$]]',
        'rows[dimension,filter,items[dimensionItem|rename(id),$]]',
        'filters[dimension,filter,items[dimensionItem|rename(id),$]]',
        'access',
        '!lastUpdated',
        '!href',
        '!created',
