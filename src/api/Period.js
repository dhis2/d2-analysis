...
Period.prototype.getItemsByTypeByFinancialApril = function(type, isAll) {
    ...
    if (type === 'FinancialApril') {
        if (isAll) {
            return this.getItemifiedPeriods(
                this.gen(type, this.offset - 1 + this.yearOffset).slice(0, 2)
            );
        }

        return this.getItemifiedPeriods(
            this.gen(type, this.offset + this.yearOffset).slice(0, 1)
        );
        ...
        return this.getItemifiedPeriods(
            [].concat(thisPeriods, nextPeriods.slice(0, 1))
        );
    } else if (type === 'Quarterly') {
        return this.getItemifiedPeriods(
            [].concat(thisPeriods.slice(1), nextPeriods.slice(0, 1))
        );
    } else if (type === 'BiMonthly') {
        return this.getItemifiedPeriods(
            [].concat(thisPeriods.slice(1), nextPeriods.slice(0, 2))
        );
        ...
        return this.getItemifiedPeriods(
            [].concat(
                thisPeriods.slice(thisSliceStartIndex),
                nextPeriods.slice(0, nextSliceEndIndex)
            )
        );
        ...
        for (var i = 0, biWeek; i < thisPeriods.length; i++) {
            ...
            if (
                biWeek.startDate.slice(0, 7) === startMonth ||
                biWeek.endDate.slice(0, 7) === startMonth
            ) {
                thisSliceStartIndex = i;
            }
        }
        ...
        for (var j = 0, biWeek; j < nextPeriods.length; j++) {
            ...
            if (
                biWeek.startDate.slice(0, 7) === endMonth &&
                biWeek.endDate.slice(0, 7) === endMonth
            ) {
                nextSliceEndIndex = j;
            }
        }
        ...
        for (var i = 0, week; i < thisPeriods.length; i++) {
            ...
            if (
                week.startDate.slice(0, 7) === startMonth ||
                week.endDate.slice(0, 7) === startMonth
            ) {
                thisSliceStartIndex = i;
            }
        }
        ...
        for (var j = 0, week; j < nextPeriods.length; j++) {
            ...
            if (
                week.startDate.slice(0, 7) === endMonth &&
                week.endDate.slice(0, 7) === endMonth
            ) {
                nextSliceEndIndex = j;
            }
        }
...
Period.prototype.getItemsByTypeByFinancialJuly = function(type, isAll) {
    ...
    if (type === 'FinancialApril') {
        return this.getItemifiedPeriods(
            this.gen(type, this.offset + this.yearOffset).slice(0, 2)
        );
    } else if (type === 'FinancialJuly') {
        if (isAll) {
            return this.getItemifiedPeriods(
        ...
        return this.getItemifiedPeriods(
            [].concat(thisPeriods.slice(2), nextPeriods.slice(0, 2))
        );
    } else if (type === 'BiMonthly') {
        return this.getItemifiedPeriods(
            [].concat(thisPeriods.slice(3), nextPeriods.slice(0, 3))
        );
    } else if (type === 'Monthly') {
        for (var i = 0, month; i < thisPeriods.length; i++) {
            month = thisPeriods[i];
...
Period.prototype.getItemsByTypeByFinancialOct = function(type, isAll) {
    ...
    if (type === 'FinancialApril') {
        ...
        return this.getItemifiedPeriods(
            [].concat(thisPeriods.slice(1), nextPeriods)
        );
    } else if (type === 'Quarterly') {
        return this.getItemifiedPeriods(
            [].concat(thisPeriods.slice(3), nextPeriods.slice(0, 3))
        ...
        return this.getItemifiedPeriods(
            [].concat(thisPeriods.slice(4), nextPeriods.slice(0, 5))
        );
    } else if (type === 'Monthly') {
        for (var i = 0, month; i < thisPeriods.length; i++) {
            month = thisPeriods[i];
...
Period.prototype.getItemsByTypeByYear = function(type) {
    if (type === 'FinancialOct') {
        return this.getItemifiedPeriods(
            this.genRev(type, this.offset - 5).slice(0, 2)
        );
    } else if (type === 'FinancialJuly') {
        return this.getItemifiedPeriods(
            this.genRev(type, this.offset - 5).slice(0, 2)
        ...
        return this.getItemifiedPeriods(
            this.genRev(type, this.offset - 5).slice(0, 1)
        );
    } else if (type === 'SixMonthlyApril') {
...
Period.prototype.getItemsByTypeBySixmonthApril = function(type, isAll) {
    ...
    if (type === 'FinancialOct') {
        ...
        return this.getItemifiedPeriods(
            this.gen(type, this.offset + this.yearOffset + offset).slice(0, 1)
        );
    } else if (type === 'FinancialJuly') {
        offset = sixmonthapril === 1 ? -1 : 0;
        ...
        return this.getItemifiedPeriods(
            this.gen(type, this.offset + this.yearOffset + offset).slice(
                0,
                sliceEndIndex
            )
        );
        ...
        return this.getItemifiedPeriods(
            this.gen(type, this.offset + this.yearOffset).slice(
                0,
                sliceEndIndex
            )
        );
        ...
        if (isAll) {
            return this.getItemifiedPeriods(
                this.gen(type, this.offset - 1)
                    .slice(1, 2)
                    .concat(this.gen(type, this.offset))
            );
        }

        return this.getItemifiedPeriods([
            this.gen(type, this.offset)[sixmonthapril - 1],
        ]);
    } else if (type === 'SixMonthly') {
        var offset = sixmonthapril === 1 ? 0 : 1;
        return this.getItemifiedPeriods(
            this.gen(type, this.offset)
                .slice(1, 2)
                .concat(this.gen(type, this.offset + offset).slice(0, 1))
        );
    } else if (type === 'Quarterly') {
        var quarters = [];
        ...
        if (sixmonthapril === 1) {
            ...
            quarters = quarters.concat(
                this.gen(type, this.offset + 1).slice(0, 1)
            );
        }
        ...
        if (sixmonthapril === 1) {
            ...
            bimonths = bimonths.concat(
                this.gen(type, this.offset + 1).slice(0, 2)
            );
        }
        ...
        if (sixmonthapril === 1) {
            for (var i = 0, biweek, sm, em; i < allBiweeks.length; i++) {
                ...
                if (
                    numberConstrain(sm, 4, 9) === sm ||
                    numberConstrain(em, 4, 9) === em
                ) {
                    biweeks.push(biweek);
                }
            }
...
Period.prototype.getItemsByTypeBySixmonth = function(type, isAll) {
    ...
    if (type === 'FinancialOct') {
        ...
        return this.getItemifiedPeriods([
            this.gen(type, this.offset)[sixmonth - 1],
        ]);
    } else if (type === 'Quarterly') {
        ...
        return this.getItemifiedPeriods(
            this.gen(type, this.offset).slice(sliceStartIndex, sliceEndIndex)
        );
    } else if (type === 'BiMonthly') {
        ...
        for (var i = 0, sd, ed, sy, ey; i < allBiweeks.length; i++) {
            ...
            if (
                (sd >= firstMonth && sd <= lastMonth) ||
                (ed >= firstMonth && ed <= lastMonth)
            ) {
                if (
                    (sixmonth === 1 && ey !== this.year) ||
                    (sixmonth === 2 && sy !== this.year)
                ) {
                    continue;
                }
...
Period.prototype.getItemsByTypeByQuarter = function(type, isAll) {
    var quarterStr = this.id.slice(5, 6),
        ...
        firstMonth =
            quarter === 1 ? 1 : quarter === 2 ? 4 : quarter === 3 ? 7 : 10,
        lastMonth =
            quarter === 1 ? 3 : quarter === 2 ? 6 : quarter === 3 ? 9 : 12,
        startIndex,
        endIndex,
        offset;
    ...
    if (type === 'FinancialOct') {
        ...
        return this.getItemifiedPeriods(
            this.gen(type, this.offset + offset).slice(0, 1)
        );
    } else if (type === 'FinancialJuly') {
        ...
        return this.getItemifiedPeriods(
            this.gen(type, this.offset + 5).slice(0, 1)
        );
    } else if (type === 'SixMonthlyApril') {
        ...
        return this.getItemifiedPeriods(
            this.genRev(type, this.offset + offset).slice(0, index)
        );
    } else if (type === 'SixMonthly') {
        ...
        return this.getItemifiedPeriods(
            this.gen(type, this.offset).slice(startIndex, endIndex)
        );
    } else if (type === 'Quarterly') {
        if (isAll) {
            return this.getItemifiedPeriods(this.gen(type, this.offset));
        ...
        return this.getItemifiedPeriods(
            this.gen(type, this.offset).slice(quarter - 1, quarter)
        );
    } else if (type === 'BiMonthly') {
        startIndex =
            quarter === 1 ? 0 : quarter === 2 ? 1 : quarter === 3 ? 3 : 4;
        ...
        for (var i = 0, sd, ed, sy, ey; i < allBiWeeks.length; i++) {
            ...
            if (
                ...
                if (
                    (quarter === 1 && ey !== this.year) ||
                    (quarter === 4 && sy !== this.year)
                ) {
                    continue;
                }
...
Period.prototype.getItemsByTypeByBimonth = function(type, isAll) {
    ...
    if (type === 'FinancialOct') {
        ...
        if (bimonth === 1) {
            sixmonthaprils.push(
                this.gen('SixMonthlyApril', this.offset - 1)[1]
            );
        } else if (bimonth === 2) {
            sixmonthaprils.push(
                this.gen('SixMonthlyApril', this.offset - 1)[1]
        ...
        return this.getItemifiedPeriods(
            this.gen('Quarterly', this.offset).slice(
                sliceStartIndex,
                sliceEndIndex
            )
        );
        ...
        return this.getItemifiedPeriods(
            this.gen(type, this.offset).slice(bimonth - 1, bimonth)
        );
    } else if (type === 'Monthly') {
        var sliceStartIndex =
                bimonth === 1
        ...
        for (var i = 0, sd, ed, sy, ey; i < allBiWeeks.length; i++) {
            ...
            if (
                ...
                if (
                    (bimonth === 1 && ey !== this.year) ||
                    (bimonth === 4 && sy !== this.year)
                ) {
                    continue;
                }
...
Period.prototype.getItemsByTypeByMonth = function(type, isAll) {
    ...
    if (type === 'FinancialOct') {
        ...
        return this.getItemifiedPeriods(
            this.gen(type, this.offset).slice(month - 1, month)
        );
    } else if (type === 'BiWeekly') {
        var t = this,
        ...
        for (var i = 0, sd, ed, biweek; i < allBiWeeks.length; i++) {
            ...
            if (
                sd.substring(0, 7) === monthTestString ||
                ed.substring(0, 7) === monthTestString
            ) {
                biWeeks.push(biweek);
            }
        }
...
Period.prototype.getItemsByTypeByBiweek = function(type, isAll) {
    ...
    if (type === 'FinancialOct') {
        ...
        return this.getItemifiedPeriods(
            this.gen(
                'FinancialOct',
                this.offset + this.yearOffset + offset
        ...
        return this.getItemifiedPeriods(
            this.gen('Yearly', this.offset + this.yearOffset + offset).slice(
                0,
                sliceEndIndex
            )
        );
        ...
        if (
            numberConstrain(startDateMonth, 4, 9) === startDateMonth ||
            numberConstrain(endDateMonth, 4, 9) === endDateMonth
        ) {
            sixmonthaprils.push(this.gen('SixMonthlyApril', this.offset)[0]);
        }
        ...
        var allSixmonths = this.gen(type, this.offset),
            actualSixmonthIndexes = arrayUnique([
                Math.ceil(startDateMonth / 6),
                Math.ceil(endDateMonth / 6),
            ]),
            sixmonths = [];
        ...
        var allQuarters = this.gen(type, this.offset),
            actualQuarterIndexes = arrayUnique([
                Math.ceil(startDateMonth / 3),
                Math.ceil(endDateMonth / 3),
            ]),
            quarters = [];
        ...
        var allBimonths = this.gen(type, this.offset),
            actualBimonthIndexes = arrayUnique([
                Math.ceil(startDateMonth / 2),
                Math.ceil(endDateMonth / 2),
            ]),
            bimonths = [];
        ...
        if (startDateMonth === 12 && endDateMonth === 1) {
            ...
            var actualMonthIndexes = arrayUnique([
                startDateMonth,
                endDateMonth,
            ]);
            ...
            for (
                var i = 0,
                    monthIndexes = arrayUnique([startDateMonth, endDateMonth]);
                i < monthIndexes.length;
                i++
            ) {
        ...
        if (biweekPeriod.startDate.slice(0, 4) < this.year) {
            for (
                var i = 0,
                    lastDaysLastYear = this.gen(type, this.offset - 1).slice(
                        358
                    ),
                    day;
                i < lastDaysLastYear.length;
                i++
            ) {
        ...
        if (biweekPeriod.endDate.slice(0, 4) > this.year) {
            for (
                var i = 0,
                    firstDaysNextYear = this.gen(type, this.offset + 1).slice(
                        0,
                        7
                    ),
                    day;
                i < firstDaysNextYear.length;
                i++
            ) {
...
Period.prototype.getItemsByTypeByDay = function(type, isAll) {
    ...
    if (type === 'FinancialOct') {
        ...
        return this.getItemifiedPeriods(
            this.gen(type, this.offset + offset).slice(
                sliceStartIndex,
                sliceEndIndex
            )
        );
        ...
        var sliceStartIndex =
            month <= 3 ? 0 : month <= 6 ? 1 : month <= 9 ? 2 : 3;
        sliceEndIndex = sliceStartIndex + 1;
        ...
        for (var i = 0, sd, ed; i < allBiWeeks.length; i++) {
            ...
            if (
                sd.substring(5, 7) === monthStr ||
                ed.substring(5, 7) === monthStr
            ) {
                if (
                    sd.substring(8, 10) <= dayStr ||
                    ed.substring(8, 10) >= dayStr
                ) {
                    biWeek = allBiWeeks[i];
                    break;
                }
...
Period.prototype.generateDisplayProperties = function() {
    ...
    if (type === 'Daily') {
        ...
        this.typeName = 'Daily';
        this.displayName =
            parseInt(this.name.split('-')[2]) +
            ' ' +
            months[new Date(this.name).getMonth()] +
            ', ' +
            this.year;
        ...
        this.getContextMenuItemsConfig = function() {
            ...
            items.push({
                isSubtitle: true,
                style:
                    'padding: 5px 5px 5px 5px; font-size: 120%; font-weight:bold',
            ...
            (function() {
                items.push({
                    ...
                    text:
                        'Show <span class="name">financial April ' +
                        p.year +
                        '</span>',
            ...
            (function() {
                items.push({
                    ...
                    text:
                        'Show <span class="name">financial July ' +
                        p.year +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
            ...
            (function() {
                items.push({
                    ...
                    text:
                        'Show <span class="name">financial October ' +
                        p.year +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
            ...
            (function() {
                ...
                items.push({
                    items: periods,
                    text:
                        'Show <span class="name">' +
                        p.getNameByParents(periods, 'six-month') +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
            })();
            ...
            (function() {
                ...
                items.push({
                    ...
                    text:
                        'Show <span class="name">' +
                        p.getNameByParents(periods, 'quarter') +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
            })();
            ...
            (function() {
                ...
                items.push({
                    ...
                    text:
                        'Show <span class="name">' +
                        p.getNameByParents(periods, 'bi-month') +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
            })();
            ...
            (function() {
                ...
                items.push({
                    ...
                    text:
                        'Show <span class="name">' +
                        p.getNameByParents(periods, 'month') +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
            })();
            ...
            (function() {
                ...
                items.push({
                    ...
                    text:
                        'Show <span class="name">' +
                        p.getNameByParents(periods, 'bi-week') +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
            })();
            ...
            (function() {
                ...
                items.push({
                    ...
                    text:
                        'Show <span class="name">' +
                        p.getNameByParents(periods, 'week') +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
            })();
            ...
            items.push({
                ...
                text:
                    'Show <span class="name">' + p.displayName + '</span> only',
                iconCls: 'ns-menu-item-float',
            });
            ...
            items.push({
                ...
                text:
                    'Show all <span class="name">days</span> in <span class="name">' +
                    p.year +
                    '</span>',
                iconCls: 'ns-menu-item-float',
            });
        ...
        this.getContextMenuItemsConfig = function() {
            ...
            items.push({
                ...
                text:
                    'Show all <span class="name">weeks</span> in <span class="name">' +
                    p.year +
                    '</span>',
                iconCls: 'ns-menu-item-float',
            });
            ...
            (function() {
                items.push({
                    ...
                    text:
                        'Show <span class="name">days</span> in <span class="name">' +
                        p.displayName +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
        ...
        this.getContextMenuItemsConfig = function() {
            ...
            (function() {
                ...
                items.push({
                    ...
                    text:
                        'Show <span class="name">' +
                        p.getNameByParents(periods, 'monthly') +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
            })();
            ...
            items.push({
                ...
                text:
                    'Show all <span class="name">bi-weeks</span> in <span class="name">' +
                    p.year +
                    '</span>',
                iconCls: 'ns-menu-item-float',
            });
            ...
            (function() {
                items.push({
                    ...
                    text:
                        'Show <span class="name">weeks</span> in <span class="name">' +
                        p.displayName +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
        ...
        this.getContextMenuItemsConfig = function() {
            ...
            (function() {
                ...
                items.push({
                    items: periods,
                    text:
                        'Show <span class="name">six-month April' +
                        getSuffix(periods) +
                        ' ' +
                        p.year +
                        '</span>',
            ...
            (function() {
                ...
                items.push({
                    ...
                    text:
                        'Show <span class="name">' +
                        p.getNameByParents(periods, 'bimonthly') +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
            })();
            ...
            items.push({
                ...
                text:
                    'Show all <span class="name">months</span> in <span class="name">' +
                    p.year +
                    '</span>',
                iconCls: 'ns-menu-item-float',
            });
            ...
            (function() {
                items.push({
                    ...
                    text:
                        'Show <span class="name">bi-weeks</span> in <span class="name">' +
                        p.name +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
        ...
        this.getContextMenuItemsConfig = function() {
            ...
            items.push({
                ...
                text:
                    'Show all <span class="name">bi-months</span> in <span class="name">' +
                    p.year +
                    '</span>',
                iconCls: 'ns-menu-item-float',
            });
            ...
            (function() {
                items.push({
                    ...
                    text:
                        'Show <span class="name">months</span> in <span class="name">' +
                        p.displayName +
                        ' ' +
                        p.year +
                        '</span>',
        ...
        this.getContextMenuItemsConfig = function() {
            ...
            (function() {
                ...
                items.push({
                    ...
                    text:
                        'Show <span class="name">' +
                        p.getNameByParents(periods, 'six-month April') +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
            })();
            ...
            items.push({
                ...
                text:
                    'Show all <span class="name">quarters</span> in <span class="name">' +
                    p.year +
                    '</span>',
                iconCls: 'ns-menu-item-float',
            });
            ...
            (function() {
                items.push({
                    ...
                    text:
                        'Show <span class="name">bi-months</span> in <span class="name">' +
                        p.name +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
        ...
        this.getContextMenuItemsConfig = function() {
            ...
            items.push({
                ...
                text:
                    'Show all <span class="name">six-months</span> in <span class="name">' +
                    p.year +
                    '</span>',
                iconCls: 'ns-menu-item-float',
            });
            ...
            (function() {
                items.push({
                    ...
                    text:
                        'Show <span class="name">quarters</span> in <span class="name">' +
                        p.name +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
        ...
        this.getContextMenuItemsConfig = function() {
            ...
            (function() {
                ...
                items.push({
                    items: periods,
                    text:
                        'Show <span class="name">financial Apri ' +
                        p.year +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
            ...
            (function() {
                ...
                items.push({
                    ...
                    text:
                        'Show <span class="name">' +
                        (getSuffix(periods) ? 'parent years' : p.year) +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
            })();
            ...
            items.push({
                ...
                text:
                    'Show all <span class="name">six-month Aprils</span> in <span class="name">' +
                    p.year +
                    '</span>',
                iconCls: 'ns-menu-item-float',
            });
            ...
            (function() {
                ...
                items.push({
                    items: periods,
                    text:
                        'Show <span class="name">six-months</span> in <span class="name">' +
                        p.name +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
        ...
        this.getContextMenuItemsConfig = function() {
            ...
            (function() {
                items.push({
                    ...
                    text:
                        'Show <span class="name">six-month Aprils</span> in <span class="name">' +
                        p.name +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
        ...
        this.getContextMenuItemsConfig = function() {
            ...
            items.push({
                ...
                text:
                    'Show all <span class="name">financial Octobers</span> in <span class="name">' +
                    p.year +
                    '</span>',
                iconCls: 'ns-menu-item-float',
            });
            ...
            (function() {
                items.push({
                    ...
                    text:
                        'Show <span class="name">years</span> in <span class="name">' +
                        p.name +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
        ...
        this.getContextMenuItemsConfig = function() {
            ...
            items.push({
                ...
                text:
                    'Show all <span class="name">financial Julys</span> in <span class="name">' +
                    p.year +
                    '</span>',
                iconCls: 'ns-menu-item-float',
            });
            ...
            (function() {
                items.push({
                    ...
                    text:
                        'Show <span class="name">financial Octobers</span> in <span class="name">' +
                        p.name +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
        ...
        this.getContextMenuItemsConfig = function() {
            ...
            items.push({
                ...
                text:
                    'Show all <span class="name">financial Aprils</span> in <span class="name">' +
                    p.year +
                    '</span>',
                iconCls: 'ns-menu-item-float',
            });
            ...
            (function() {
                items.push({
                    ...
                    text:
                        'Show <span class="name">financial Julys</span> in <span class="name">' +
                        p.name +
                        '</span>',
                    iconCls: 'ns-menu-item-float',
                });
